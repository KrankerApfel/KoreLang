...
export const Footer: React.FC<FooterProps> = ({ project }) => {
  return (
    <footer className="h-6 bg-[var(--bg-panel)] border-t border-neutral-700 flex items-center px-4 text-xs gap-4 shrink-0 z-50 relative" style={{ color: 'var(--text-2)' }}>
      ...
      <span style={{ color: 'var(--text-2)' }}>{project.projectName}</span>
      <span className="font-mono text-[11px]" style={{ color: 'var(--text-2)', opacity: 0.8 }}>v1.1</span>
